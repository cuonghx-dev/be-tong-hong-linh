...
const ROWS: Row[] = [
  { date: '02/07/2026', code: 'PT00125', desc: 'Thu tiền bán hàng khách lẻ', amount: 12_500_000, partner: 'Khách lẻ' },
  { date: '02/07/2026', code: 'PC00098', desc: 'Chi mua văn phòng phẩm', amount: -1_200_000, partner: 'CTY Thiên Long' },
  { date: '01/07/2026', code: 'PT00124', desc: 'Thu công nợ khách hàng ABC', amount: 45_000_000, partner: 'CTY ABC' },
  { date: '01/07/2026', code: 'PC00097', desc: 'Chi lương nhân viên tháng 6', amount: -80_000_000, partner: 'Nội bộ' },
  { date: '30/06/2026', code: 'PT00123', desc: 'Thu tiền tạm ứng còn thừa', amount: 3_200_000, partner: 'Nguyễn Văn A' },
]
      ...
      <div className="flex items-center border-t border-border px-3 py-2 text-sm text-slate-500">
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          <div className="flex items-center gap-1">
            ...
            <button className="rounded px-2 py-1 hover:bg-slate-100">3</button>
