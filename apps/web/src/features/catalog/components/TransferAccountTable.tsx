          ...
          <tbody>
            ...
            {rows.map((r) => (
              <tr key={r.id} className="group border-t border-border hover:bg-slate-50">
                ...
                <td className="px-3 py-2 text-slate-700">{r.fromAccount}</td>
                <td className="px-3 py-2 text-slate-700">{r.toAccount}</td>
                <td className="px-3 py-2 text-slate-600">{TRANSFER_SIDE_LABELS[r.side]}</td>
                <td className="max-w-[280px] truncate px-3 py-2 text-slate-600">
                  {r.description}
                </td>
                <td className="px-3 py-2">
                  <span
