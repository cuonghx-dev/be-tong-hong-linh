...
import { SalesPaymentMode } from '@prisma/client'
...
export class SalesController {
  ...
  // Số phụ thuộc tùy chọn thanh toán: thu tiền mặt ngay → PT, chưa thu → BH.
  @Get('next-no')
  ...
  nextNo(
    ...
    return this.sales.previewNextVoucherNo(voucherDate, paymentMode)
  }
