...
async function pickOrCreateBankAccount(page: Page, accountNumber: string) {
  const picker = page.getByPlaceholder('Số TK ngân hàng')
  await picker.click()
  ...
  await page.getByLabel('Thêm tài khoản ngân hàng').click()
